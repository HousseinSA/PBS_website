<?php
 ...
 require_once(\ProcessWire\wire('files')->compile(dirname(\ProcessWire\wire("config")->paths->root . 'site/modules/ProcessWire-AIOM-All-In-One-Minify-3.2.1/lib/Less/Cache.php').'/Version.php',array('includes'=>true,'namespace'=>true,'modules'=>false,'skipIfNamespace'=>false)));
...
class Less_Cache{
    ...
    public static function Cache( &$less_files, $parser_options = array() ){
        ...
        $file = dirname(\ProcessWire\wire("config")->paths->root . 'site/modules/ProcessWire-AIOM-All-In-One-Minify-3.2.1/lib/Less/Cache.php') . '/Less.php';
