...
\ProcessWire\wire('classLoader')->addNamespace('Thepixeldeveloper\Sitemap', \ProcessWire\wire("config")->paths->root . 'site/modules/MarkupSitemap' . '/src/Sitemap');
\ProcessWire\wire('classLoader')->addNamespace('Rockett\Concerns', \ProcessWire\wire("config")->paths->root . 'site/modules/MarkupSitemap' . '/src/Concerns');
\ProcessWire\wire('classLoader')->addNamespace('Rockett\Support', \ProcessWire\wire("config")->paths->root . 'site/modules/MarkupSitemap' . '/src/Support');
