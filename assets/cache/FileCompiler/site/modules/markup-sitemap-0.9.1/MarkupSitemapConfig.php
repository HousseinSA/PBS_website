...
class MarkupSitemapConfig extends \ProcessWire\ModuleConfig
{
  ...
  public function getInputFields(): InputfieldWrapper
  {
    ...
    $excludeTemplatesField = $this->buildInputField('AsmSelect', [
      ...
      'icon' => 'remove',
      'collapsed' => \ProcessWire\Inputfield::collapsedBlank,
    ]);
    foreach ($templates as $template) {
      if ($template->id !== 1) {
    ...
    $stylesheetFieldset = $this->buildInputField('Fieldset', [
      ...
      'collapsed' => \ProcessWire\Inputfield::collapsedYes,
      'icon' => 'css3',
    ]);
