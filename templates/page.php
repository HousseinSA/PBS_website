				...
				<ul>
					<?php foreach ($pages->get('/hero-section/')->children() as $hero) : ?>
						<li data-transition="fade" data-slotamount="10" data-masterspeed="1200" data-delay="5000">
							...
							<div class="tp-caption slide-sub-heading sft" data-x="30" data-y="320" data-speed="1000" data-start="800" data-easing="easeOutExpo" data-endspeed="400">
...
<section class="facilities-section" style="background-position: center center ; background-size: cover; background: url(<?php echo  $facilities->image->url; ?>) ">
				...
				<div class="facililties-text pt-100 pb-70">
					...
					<div class="theme-btn">
						<a href="<?php echo $facilities->linking->link->title; ?>" class="default-btn">
							<?php echo $facilities->linking->title; ?></a>
					</div>
				</div>
			</div>
...
<section class="project-section pt-100">
	<div class="container">
		<div class="section-title text-center">
			...
			<h2><?php echo $projects->section_title; ?></h2>
			<p><?php echo $projects->section_description; ?></p>
		</div>
		<div class="slick-slider project-slider">
			<?php foreach($projects->project as $item ) :?>
			<div class="gal-item">
				<!-- GALLERY IMAGE -->
				<img src="<?php echo $item->image->url; ?>" alt="project image" class="img-fluid">
				<!-- Hover Info -->
				<div class="hover-info">
					<h6><?php echo $item->section_title; ?></h6>
					<p><?php echo $item->sub_title; ?>
					</p>
					<a href="<?php echo $pages->get('/projects/')->url;?>"><i class="fas fa-arrow-right"></i></a>
						</div>
			</div>
			<?php endforeach; ?>
